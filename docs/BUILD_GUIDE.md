...
:root {
  // Colors
  --gray-0: #ffffff;  --gray-50: #f7f7f9; --gray-100: #eceef2; --gray-200: #d9dce3;
  --gray-400: #9aa1ae; --gray-500: #6b7280; --gray-700: #2a2f3a; --gray-800: #1c2029;
  --gray-850: #161a22; --gray-900: #0f1217; --gray-950: #0a0c10;
  ...
  --z-dropdown: 100; --z-sticky: 200; --z-modal: 400; --z-toast: 500; --z-palette: 600;

  // Layout
  --sidebar-width: 248px; --topbar-height: 56px; --content-max: 1200px;
}
```
...
@mixin focus-ring { outline: 2px solid var(--color-focus-ring); outline-offset: 2px; }
```
